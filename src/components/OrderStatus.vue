<template>
    ...
    <ion-badge v-if="status === '3'" :style="`background-color: #6c757d; color: #fff`">Delivered</ion-badge>
    <ion-badge v-if="status === '4'" :style="`background-color: #28a745; color: #fff`">Order Complete</ion-badge>
</template>
